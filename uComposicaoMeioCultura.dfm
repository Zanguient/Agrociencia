object frmComposicaoMeioCultura: TfrmComposicaoMeioCultura
  ...
  object gbMeioCultura: TGroupBox
    ...
    Height = 67
    Align = alTop
    Caption = '  Selecione o Meio de Cultura  '
    TabOrder = 1
    DesignSize = (
      728
      67)
    object btBuscaComponentes: TSpeedButton
      AlignWithMargins = True
      Left = 614
      Top = 18
      Width = 109
      ...
      OnClick = btBuscaComponentesClick
      ExplicitLeft = 616
      ExplicitTop = 3
      ExplicitHeight = 51
    end
    ...
    object edtMeioCultura: TButtonedEdit
      AlignWithMargins = True
      Left = 9
      Top = 33
      Width = 99
    ...
    object edtNomeMeioCultura: TEdit
      Left = 114
      Top = 33
      Width = 496
      Height = 27
