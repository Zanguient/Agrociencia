object frmComposicaoMeioCultura: TfrmComposicaoMeioCultura
  Left = 0
  Top = 0
  BorderStyle = bsNone
  Caption = 'Tela de Composi'#231#227'o de Meio de Cultura'
  ClientHeight = 559
  ClientWidth = 751
  Color = clWhite
  ...
  object pnCadastro: TPanel
    ...
    object gbEspecie: TGroupBox
      ...
      object edt_CodigoEspecie: TButtonedEdit
        ...
        RightButton.Visible = True
        TabOrder = 1
        OnChange = edt_CodigoEspecieChange
        OnKeyDown = edt_CodigoEspecieKeyDown
        OnRightButtonClick = edt_CodigoEspecieRightButtonClick
      end
      ...
      object cbTodasEspecies: TCheckBox
        AlignWithMargins = True
        Left = 11
        Top = 28
        Width = 110
        Height = 17
        Caption = 'Todas Esp'#233'cies'
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clWindowText
        Font.Height = -13
        Font.Name = 'Tahoma'
  ...
  object cds_Componentes: TClientDataSet
    ...
    Left = 480
    Top = 240
    object cds_ComponentesIDPRODUTO: TIntegerField
      DisplayLabel = 'C'#243'd. Mat. Prima'
      FieldName = 'IDPRODUTO'
    end
    object cds_ComponentesNOMEPRODUTO: TStringField
      DisplayLabel = 'Nome Produto'
      FieldName = 'NOMEPRODUTO'
      Size = 100
    end
    object cds_ComponentesQUANTIDADE: TFloatField
  ...
  object cds_Pesquisa: TClientDataSet
    ...
    object cds_PesquisaCODIGOMC: TStringField
      Alignment = taCenter
  ...
  object cds_Especies: TClientDataSet
    Aggregates = <>
    Params = <>
    Left = 640
    Top = 224
    object cds_EspeciesID: TIntegerField
      FieldName = 'ID'
    end
    object cds_EspeciesID_ESPECIE: TIntegerField
      FieldName = 'ID_ESPECIE'
    end
    object cds_EspeciesESPECIE: TStringField
      DisplayLabel = 'Esp'#233'cie'
      FieldName = 'ESPECIE'
      Size = 100
    end
  end
  object ds_Especies: TDataSource
    DataSet = cds_Especies
    Left = 584
    Top = 192
  end
end
