object frmCadastroUnidadeMedida: TfrmCadastroUnidadeMedida
  Left = 0
  Top = 0
  ...
  object pnVisualizacao: TPanel
    ...
    object Panel2: TPanel
      ...
      Align = alTop
      BevelOuter = bvNone
      Caption = 'Lista das Unidades de Medida'
      Color = clSkyBlue
      Font.Charset = DEFAULT_CHARSET
      Font.Color = clWindowText
      Font.Height = -21
  ...
  object ds_UnidadeMedida: TDataSource
    DataSet = cds_UnidadeMedida
    Left = 296
    Top = 192
  end
  object cds_UnidadeMedida: TClientDataSet
    Aggregates = <>
    Params = <>
    OnFilterRecord = csPesquisaFilterRecord
    Left = 400
    Top = 192
    object cds_UnidadeMedidaID: TIntegerField
      DisplayLabel = 'C'#243'digo'
      FieldName = 'ID'
    end
    object cds_UnidadeMedidaDESCRICAO: TStringField
      DisplayLabel = 'Descri'#231#227'o'
      DisplayWidth = 50
      FieldName = 'DESCRICAO'
      Size = 100
    end
    object cds_UnidadeMedidaSIMBOLO: TStringField
      FieldName = 'SIMBOLO'
      Size = 5
    end
    object cds_UnidadeMedidaCODIGOEXTERNO: TStringField
