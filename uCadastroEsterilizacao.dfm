object frmCadastroEsterilizacao: TfrmCadastroEsterilizacao
  Left = 0
  Top = 0
  ActiveControl = edPesquisa
  BorderStyle = bsNone
  Caption = 'Cadastro de Esteriliza'#231#227'o'
  ClientHeight = 504
  ClientWidth = 861
  Color = clBtnFace
  ...
  object pnVisualizacao: TPanel
    ...
    object Panel2: TPanel
      ...
      Align = alTop
      BevelOuter = bvNone
      Caption = 'Lista de Esteriliza'#231#245'es'
      Color = clSkyBlue
      Font.Charset = DEFAULT_CHARSET
      Font.Color = clWindowText
      Font.Height = -21
  ...
  object cds_Pesquisa: TClientDataSet
    ...
    object cds_PesquisaMETODO: TStringField
